...
alias rmrf="rm -rf"
alias tlf="tail -f"
alias tarp="tar --disable-copyfile -zcvf"
...
if [[ "$rosa_server" =~ "$(uname -n)" && -z "$1" ]] || [[ $1 == "rosa" ]]; then
	...
	af () {
	    conda activate /fs/s6k/groups/agecodatasci/PEOPLE/FlorianTrigodet/VIRTUAL_ENVS/anvio-flo
        export CONDA_DEFAULT_ENV="anvi'o flo"
	}
    alias alphaf="module load AlphaFold"
	alias ml="cd $GROUPDSS && ll"
	alias wd="cd /fs/s6k/groups/agecodatasci/PEOPLE/FlorianTrigodet/test_profiler  && ll"
	alias wds="cd /fs/s6k/groups/agecodatasci/PROJECTS/Structural_Pangenome/PELAGIBACTERACEAE  && ll"
	alias wdp="cd /fs/s6k/groups/agecodatasci/PROJECTS/POLAR_AUTOSAMPLERS/YIPPEE/hifiasm/01_CONTIGS/ && ll"
	alias wdgr="cd /fs/s6k/groups/agecodatasci/PROJECTS/DGRs/TARA/row_by_row_filtered_files/subset_by_size_row_by_row/biosample_final/BioSamples/surface_water_layer_samples_5_samples/SAMEA2732139  && ll"
  alias a="cd $GROUPDSS/SOFTWARE/anvio/anvio/ && ll"
  alias aa="cd /fs/s6k/groups/agecodatasci/PEOPLE/FlorianTrigodet/SOFTWARE/anvio/anvio/ && ll"
    ...
    alias sq="squeue -o \"%.25i %.9P %.15j %.8u %.2t %.10M %.6D %R %.6C %.6m\""
