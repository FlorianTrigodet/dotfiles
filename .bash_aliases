...
if [[ "$carl_server" =~ "$(uname -n)" && -z "$1" ]] || [[ $1 == "carl" ]]; then
	...
	alias gtdb="cd /gss/work/nand5072/RESOURCES/PUBLIC/GENOMES/GTDB && pwd"
	...
	alias q="squeue --user=patz5242,bube0466 -o '%11i %35j %5u %5C %13m %8T %10M %9l %6D %R'; echo ; \
		squeue --user=patz5242,bube0466 -O 'arrayjobid:13,name:35,stdout:120'"
	alias sc="scancel"
